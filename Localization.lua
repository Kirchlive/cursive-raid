...
L:RegisterTranslations("enUS", function()
	...
	["Time threshold for refreshing DoTs when Dark Harvest is off cooldown. Ensures DoTs have enough duration before channeling Dark Harvest. Example: harvestrefresh=6"] = true,
		...
		["Shared Elune's Radiance"] = true,
		["Shared Elune's Twilight"] = true,
		["Shared Elune's Rage"] = true,
		["Shared Elune's Wrath"] = true,
		["Shared Elune's Grace"] = true,
		["Shared Elune's Ire"] = true,
		...
		["Track Burning Zeal (Priest T3.5) on targets"] = true,
		...
		["Track Elune's Radiance (Holy Scythe) on targets"] = true,
		["Track Elune's Twilight (Shadow Scythe) on targets"] = true,
		["Track Elune's Rage (Fire Scythe) on targets"] = true,
		["Track Elune's Wrath (Arcane Scythe) on targets"] = true,
		["Track Elune's Grace (Nature Scythe) on targets"] = true,
		["Track Elune's Ire (Frost Scythe) on targets"] = true,
...
L:RegisterTranslations("zhCN", function()
	...
	["Time threshold for refreshing DoTs when Dark Harvest is off cooldown. Ensures DoTs have enough duration before channeling Dark Harvest. Example: harvestrefresh=6"] = "当黑暗收割冷却就绪时刷新DoT的时间阈值。确保DoT在引导黑暗收割前有足够的持续时间。示例：harvestrefresh=6.",
		...
		["puncture armor"] = "穿刺护甲",
		["potent venom"] = "剧毒",
		["elune's radiance"] = "艾露恩的光辉",
		["elune's twilight"] = "艾露恩的暮光",
		["elune's rage"] = "艾露恩的怒火",
		["elune's wrath"] = "艾露恩的神怒",
		["elune's grace"] = "艾露恩的恩典",
		["elune's ire"] = "艾露恩的怒意",
		["howl of terror"] = "恐惧嚎叫",
		["enslave demon"] = "奴役恶魔",
		["psychic scream"] = "心灵尖啸",
